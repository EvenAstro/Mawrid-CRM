...
export default function NewLeadSlideOver({
  ...
  return (
    <>
      ...
      />
      <aside
        className={`fixed left-0 top-0 z-50 flex h-screen w-full max-w-[460px] flex-col border-r border-[#e8ece9] bg-white shadow-2xl transition-transform duration-300 ease-in-out ${
