      ...
      <div className="pointer-events-none fixed bottom-6 right-6 z-[100] flex flex-col gap-2">
        {toasts.map((t) => {
          ...
          return (
            <div
              key={t.id}
              className={`pointer-events-auto flex items-center gap-3 rounded-xl border border-[#e5e7eb] border-l-4 bg-white px-4 py-3 shadow-lg ${s.bar} animate-[slideIn_0.2s_ease-out]`}
            >
